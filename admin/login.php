...
<head>
  ...
  <title>C.O.N.E.C.T | Log in</title>
...
<!--   <div class="login-logo">
  ...
  <div class="login-box-body" style="min-height: 400px;">
    <h1 class="login-box-msg">Login to C.O.N.E.C.T</h1>
    <hr/>
    ...
    <form action="" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-4">
          ...
          <button type="button" class="btn btn-default btn-block btn-flat" data-dismiss="modal" href="home.php">Close</button>
        </div>
      </div>
        <!-- /.col -->
      </div>
